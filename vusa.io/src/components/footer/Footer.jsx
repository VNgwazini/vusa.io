...
export default function Footer() {
  return (
    <div className="footer d-flex align-items-center justify-content-between px-1 py-4">
      <span className="d-flex justify-content-start px-2">Vusumuzi Ngwazini © 2021</span>
      <span className="d-flex justify-content-between">
        <a target="_blank" href="https://www.linkedin.com/in/vusumuzi-ngwazini/" rel="noreferrer"><LinkedIn className="mx-1"style={{fill: "navy"}}/></a>
